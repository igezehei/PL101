...
astar_count = 0 # count the number of nodes traversed for bfs.
astar_num = 0 # count the maximum number of nodes held in memory at any time for bfs
...
def depth_limited_search(problem, limit=50):
    ...
    def recursive_dls(node, problem, limit):
        ...
        if problem.goal_test(node.state):
            ...
            if len(new_nodes)+1>ids_num:
                ids_num = len(new_nodes) +1
