...
<head>
 ...
 var codesite_token = "picMbJ61xhdEZNUvFVWiUO75b4w:1375051403313";
 
 
 var CS_env = {"profileUrl":"/u/105550342260037177437/","domainName":null,"token":"picMbJ61xhdEZNUvFVWiUO75b4w:1375051403313","loggedInUserEmail":"isakebedeachs@gmail.com","projectHomeUrl":"/p/ourproject-007","assetHostPath":"https://ssl.gstatic.com/codesite/ph","projectName":"ourproject-007","relativeBaseUrl":"","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/3783617020303179221"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fourproject-007%2Fsource%2Fbrowse%2Ftrunk%2Fpart3%2Freport%2Faaai_script.sh" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/ourproject-007/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/ourproject-007/source/browse/trunk/part3/">part3</a><span class="sp">/&nbsp;</span><a href="/p/ourproject-007/source/browse/trunk/part3/report/">report</a><span class="sp">/&nbsp;</span>aaai_script.sh</span>
 ...
 <a href="/p/ourproject-007/source/browse/trunk/part3/report/aaai_script.sh?edit=1"
...
><td class="source"># This shell script produces the latex source-package of a paper<br></td></tr
><tr
id=sl_svn70_5

 onmouseover="gutterOver(5)"

><td class="source"># as required by AAAI, in preparation for printed proceedings.<br></td></tr
><tr
id=sl_svn70_6

 onmouseover="gutterOver(6)"

><td class="source"># Copyright (C) 2009 Christian Fritz &quot;fritz at cs dot toronto dot<br></td></tr
><tr
id=sl_svn70_7

 onmouseover="gutterOver(7)"

><td class="source"># edu&quot;<br></td></tr
><tr
id=sl_svn70_8
...
><td class="source"># published by the Free Software Foundation, either version 3 of<br></td></tr
><tr
id=sl_svn70_12

 onmouseover="gutterOver(12)"

><td class="source"># the License, or (at your option) any later version. <br></td></tr
><tr
id=sl_svn70_13
...
><td class="source"># License along with this program. If not, see<br></td></tr
><tr
id=sl_svn70_21

 onmouseover="gutterOver(21)"

><td class="source"># &lt;http://www.gnu.org/licenses/&gt;.<br></td></tr
><tr
id=sl_svn70_22
...
><td class="source"># function for recursive processing of style files<br></td></tr
><tr
id=sl_svn70_25

 onmouseover="gutterOver(25)"

><td class="source">recurseStyles() {<br></td></tr
><tr
id=sl_svn70_26

 onmouseover="gutterOver(26)"

><td class="source">    echo &quot;..recursively processing required packages of $1&quot;<br></td></tr
><tr
id=sl_svn70_27

 onmouseover="gutterOver(27)"

><td class="source">    PACKAGES=`grep RequirePackage $1 | sed &#39;s/RequirePackage\[[^]]*\]/RequirePackage/g&#39; | sed &#39;s/.*RequirePackage{\([^}]*\)}.*/\1/&#39; | sed -e &#39;s/, */\n/g&#39;`<br></td></tr
><tr
id=sl_svn70_28

 onmouseover="gutterOver(28)"

><td class="source">    for name in $PACKAGES; do<br></td></tr
><tr
id=sl_svn70_29

 onmouseover="gutterOver(29)"

><td class="source">	if [ ! -e sources/$name.sty ]; then <br></td></tr
><tr
id=sl_svn70_30

 onmouseover="gutterOver(30)"

><td class="source">	    echo &quot;..locating and copying: $name&quot;<br></td></tr
><tr
id=sl_svn70_31

 onmouseover="gutterOver(31)"

><td class="source">	    FILE=`locate /$name.sty | head -n 1`<br></td></tr
><tr
id=sl_svn70_32

 onmouseover="gutterOver(32)"

><td class="source">	    if [ -e $FILE ]; then<br></td></tr
><tr
id=sl_svn70_33

 onmouseover="gutterOver(33)"

><td class="source">		cp $FILE sources<br></td></tr
><tr
id=sl_svn70_34
...
><td class="source">		echo &quot;..cannot locate $name.sty&quot;<br></td></tr
><tr
id=sl_svn70_36
...
><td class="source">		recurseStyles sources/$name.sty<br></td></tr
><tr
id=sl_svn70_39
...
><td class="source"># give a tex file as parameter<br></td></tr
><tr
id=sl_svn70_47

 onmouseover="gutterOver(47)"

><td class="source">if (( $# &lt; 1 )); then<br></td></tr
><tr
id=sl_svn70_48

 onmouseover="gutterOver(48)"

><td class="source">    echo &quot;Error: Please give a tex-file as parameter, e.g., ./aaai_script.sh main.tex&quot;;<br></td></tr
><tr
id=sl_svn70_49
...
><td class="source">mkdir sources<br></td></tr
><tr
id=sl_svn70_53
...
><td class="source">echo &quot;locating and copying all used packages&quot;<br></td></tr
><tr
id=sl_svn70_55

 onmouseover="gutterOver(55)"

><td class="source">PACKAGES=`grep ^.usepackage $1 | sed -e &#39;s/.*usepackage{\(.*.\)}.*/\1/&#39; | sed -e &#39;s/, /\n/g&#39;`<br></td></tr
><tr
id=sl_svn70_56
...
><td class="source">    if [ -e $name.sty ]; then<br></td></tr
><tr
id=sl_svn70_59

 onmouseover="gutterOver(59)"

><td class="source">	cp $name.sty sources<br></td></tr
><tr
id=sl_svn70_60
...
><td class="source">echo &quot;inlining all included files&quot;<br></td></tr
><tr
id=sl_svn70_75

 onmouseover="gutterOver(75)"

><td class="source">cp $1 __tmp1<br></td></tr
><tr
id=sl_svn70_76

 onmouseover="gutterOver(76)"

><td class="source">while ( grep ^.input __tmp1 ); do<br></td></tr
><tr
id=sl_svn70_77

 onmouseover="gutterOver(77)"

><td class="source">#     INPUTS=`grep ^.input __tmp1 | sed &#39;s/.*input *{*\([^.}]*\).*/\1/&#39;`<br></td></tr
><tr
id=sl_svn70_78

 onmouseover="gutterOver(78)"

><td class="source">#     cat __tmp1 | sed &#39;/^%.*$/d&#39; &gt;  __tmp2<br></td></tr
><tr
id=sl_svn70_79

 onmouseover="gutterOver(79)"

><td class="source">#     for name in $INPUTS; do<br></td></tr
><tr
id=sl_svn70_80

 onmouseover="gutterOver(80)"

><td class="source"># 	echo &quot;inlining $name&quot;<br></td></tr
><tr
id=sl_svn70_81

 onmouseover="gutterOver(81)"

><td class="source"># 	awk -v filename=$name &#39;{ if ($0 ~ &quot;.input.*&quot;filename) { system(&quot;cat &quot;filename&quot;.tex | sed  &#39;/^%.*\$/d&#39;&quot;); } else { print $0; } }&#39; &lt; __tmp2 &gt; __tmp1<br></td></tr
><tr
id=sl_svn70_82
...
><td class="source">    awk &#39;{ if ( $0 ~ /\\input( |{)/ ) { sub(/\\input( |{)/,&quot;&quot;); sub(/}/, &quot;&quot;); sub(/\.tex/, &quot;&quot;); system(&quot;cat &quot;$0&quot;.tex | sed  &#39;/^%.*\$/d&#39;&quot;) } else { print $0; } }&#39; __tmp1 &gt; __tmp2<br></td></tr
><tr
id=sl_svn70_84

 onmouseover="gutterOver(84)"

><td class="source">    cp __tmp2 __tmp1<br></td></tr
><tr
id=sl_svn70_85
...
><td class="source">echo &quot;inlining bibitems&quot;<br></td></tr
><tr
id=sl_svn70_88

 onmouseover="gutterOver(88)"

><td class="source">BIBFILE=`echo $1 | sed &#39;s/.tex/.bbl/&#39;`<br></td></tr
><tr
id=sl_svn70_89

 onmouseover="gutterOver(89)"

><td class="source">awk -v filename=$BIBFILE &#39;{ if ($0 ~ &quot;.bibliography{&quot;) { system(&quot;cat &quot;filename); } else { print $0; } }&#39; &lt; __tmp1 &gt; __tmp2<br></td></tr
><tr
id=sl_svn70_90

 onmouseover="gutterOver(90)"

><td class="source">cp __tmp2 sources/full.tex<br></td></tr
><tr
id=sl_svn70_91
...
><td class="source">echo &quot;getting figures&quot;<br></td></tr
><tr
id=sl_svn70_94

 onmouseover="gutterOver(94)"

><td class="source">FIGURES=`grep includegraphics __tmp2 | grep -v ^% | sed &#39;s/.*{\([^}]*\)}*/\1/&#39;`<br></td></tr
><tr
id=sl_svn70_95

 onmouseover="gutterOver(95)"

><td class="source">for name in $FIGURES; do<br></td></tr
><tr
id=sl_svn70_96

 onmouseover="gutterOver(96)"

><td class="source">    echo &quot;getting figure $name&quot;<br></td></tr
><tr
id=sl_svn70_97

 onmouseover="gutterOver(97)"

><td class="source">    mkdir -p sources/`echo &quot;$name&quot; | sed &#39;s/\(.*\)\/.*/\1/&#39;`<br></td></tr
><tr
id=sl_svn70_98

 onmouseover="gutterOver(98)"

><td class="source">    cp $name.*ps sources/`echo &quot;$name&quot; | sed &#39;s/\(.*\)\/.*/\1/&#39;`<br></td></tr
><tr
id=sl_svn70_99
...
><td class="source">cd sources<br></td></tr
><tr
id=sl_svn70_104

 onmouseover="gutterOver(104)"

><td class="source">echo &quot;latexing source&quot;<br></td></tr
><tr
id=sl_svn70_105

 onmouseover="gutterOver(105)"

><td class="source">latex full.tex<br></td></tr
><tr
id=sl_svn70_106

 onmouseover="gutterOver(106)"

><td class="source">echo &quot;latexing source once more&quot;<br></td></tr
><tr
id=sl_svn70_107
...
><td class="source">echo &quot;creating the PDF using&quot;<br></td></tr
><tr
id=sl_svn70_110

 onmouseover="gutterOver(110)"

><td class="source">dvips -Ppdf -G0 -tletter full -o full.ps<br></td></tr
><tr
id=sl_svn70_111

 onmouseover="gutterOver(111)"

><td class="source">ps2pdf -sPAPERSIZE=letter -dMaxSubsetPct=100 -dCompatibilityLevel=1.2 -dSubsetFonts=false -dEmbedAllFonts=true full.ps<br></td></tr
><tr
id=sl_svn70_112

 onmouseover="gutterOver(112)"

><td class="source">cd ..<br></td></tr
><tr
id=sl_svn70_113
...
><td class="source">echo &quot;DONE&quot;<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 on Nov 23, 2011
 &nbsp; <a href="/p/ourproject-007/source/diff?spec=svn70&r=45&amp;format=side&amp;path=/trunk/part3/report/aaai_script.sh&amp;old_path=/trunk/part3/report/aaai_script.sh&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/part3/report/aaai_script.sh';
 ...
 <a href="/p/ourproject-007/source/list?path=/trunk/part3/report/aaai_script.sh&start=45">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//ourproject-007.googlecode.com/svn/trunk/part3/report/aaai_script.sh">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn70': '/trunk/part3/report/aaai_script.sh'}
 codereviews = CR_controller.setup(
 {"profileUrl":"/u/105550342260037177437/","domainName":null,"token":"picMbJ61xhdEZNUvFVWiUO75b4w:1375051403313","loggedInUserEmail":"isakebedeachs@gmail.com","projectHomeUrl":"/p/ourproject-007","assetHostPath":"https://ssl.gstatic.com/codesite/ph","projectName":"ourproject-007","relativeBaseUrl":"","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/3783617020303179221"}, '', 'svn70', paths,
