...
<head>
 ...
 var codesite_token = "WJQQi95nalnzFUGrhj1V7j6d1fs:1375051343177";
 
 
 var CS_env = {"token":"WJQQi95nalnzFUGrhj1V7j6d1fs:1375051343177","profileUrl":"/u/105550342260037177437/","projectName":"ourproject-007","projectHomeUrl":"/p/ourproject-007","assetHostPath":"https://ssl.gstatic.com/codesite/ph","loggedInUserEmail":"isakebedeachs@gmail.com","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/3783617020303179221","domainName":null,"relativeBaseUrl":""};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fourproject-007%2Fsource%2Fbrowse%2Ftrunk%2Fpart3%2Fgenplots.m" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/ourproject-007/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/ourproject-007/source/browse/trunk/part3/">part3</a><span class="sp">/&nbsp;</span>genplots.m</span>
 ...
 <a href="/p/ourproject-007/source/browse/trunk/part3/genplots.m?edit=1"
 ...
 <li><a href="/p/ourproject-007/source/browse/trunk/part3/genplots.m?r=41" title="Previous">&lsaquo;r41</a></li>
...
><td class="source">ids = gendata(&#39;IDS_Statistics.txt&#39;);<br></td></tr
><tr
id=sl_svn70_2

 onmouseover="gutterOver(2)"

><td class="source">astar = gendata(&#39;ASTAR_Statistics.txt&#39;);<br></td></tr
><tr
id=sl_svn70_3
...
><td class="source">plot(ids(:,1),ids(:,2),&#39;r+&#39;);<br></td></tr
><tr
id=sl_svn70_5

 onmouseover="gutterOver(5)"

><td class="source">hold on<br></td></tr
><tr
id=sl_svn70_6

 onmouseover="gutterOver(6)"

><td class="source">plot(ids(:,1),astar(:,2),&#39;o&#39;);<br></td></tr
><tr
id=sl_svn70_7

 onmouseover="gutterOver(7)"

><td class="source">legend(&#39;ids&#39;,&#39;astar&#39;);<br></td></tr
><tr
id=sl_svn70_8
...
><td class="source">xlabel(&#39;number of cities(nodes)&#39;);<br></td></tr
><tr
id=sl_svn70_10

 onmouseover="gutterOver(10)"

><td class="source">ylabel(&#39;time takend by bfs and astar(nodes)&#39;);<br></td></tr
><tr
id=sl_svn70_11

 onmouseover="gutterOver(11)"

><td class="source">title(&#39;Comparision of the time taken by ids and astar with varying numbers of cities&#39;);<br></td></tr
><tr
id=sl_svn70_12
...
><td class="source">print -djpeg time.jpg;<br></td></tr
><tr
id=sl_svn70_14

 onmouseover="gutterOver(14)"

><td class="source">hold off;<br></td></tr
><tr
id=sl_svn70_15

 onmouseover="gutterOver(15)"

><td class="source">clear all;<br></td></tr
><tr
id=sl_svn70_16

 onmouseover="gutterOver(16)"

><td class="source">ids_1 = gendata(&#39;IDS_Statistics.txt&#39;);<br></td></tr
><tr
id=sl_svn70_17

 onmouseover="gutterOver(17)"

><td class="source">astar_1 = gendata(&#39;ASTAR_Statistics.txt&#39;);<br></td></tr
><tr
id=sl_svn70_18
...
><td class="source">plot(ids_1(:,1),ids_1(:,3),&#39;r+&#39;);<br></td></tr
><tr
id=sl_svn70_20
...
><td class="source">plot(ids_1(:,1),astar_1(:,3),&#39;o&#39;);<br></td></tr
><tr
id=sl_svn70_22
...
><td class="source">ylabel(&#39;space takend by bfs and astar(nodes)&#39;);<br></td></tr
><tr
id=sl_svn70_26

 onmouseover="gutterOver(26)"

><td class="source">title(&#39;Comparision of the space taken by ids and astar with varying numbers of cities&#39;);<br></td></tr
><tr
id=sl_svn70_27

 onmouseover="gutterOver(27)"

><td class="source">print -djpeg space.jpg;<br></td></tr
><tr
id=sl_svn70_28
...
<script type="text/javascript">
 ...
 <p>Change log</p>
 <div>
 <a href="/p/ourproject-007/source/detail?spec=svn70&amp;r=43">r43</a>
 by coolshenwen@gmail.com
 on Nov 23, 2011
 &nbsp; <a href="/p/ourproject-007/source/diff?spec=svn70&r=43&amp;format=side&amp;path=/trunk/part3/genplots.m&amp;old_path=/trunk/part3/genplots.m&amp;old=41">Diff</a>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/ourproject-007/source/detail?r=43&spec=svn70';
 var publish_url = '/p/ourproject-007/source/detail?r=43&spec=svn70#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/trunk/part3/genplots.m');
 changed_urls.push('/p/ourproject-007/source/browse/trunk/part3/genplots.m?r\x3d43\x26spec\x3dsvn70');
 
 var selected_path = '/trunk/part3/genplots.m';
 
 
 changed_paths.push('/trunk/part3/space.jpg');
 changed_urls.push('/p/ourproject-007/source/browse/trunk/part3/space.jpg?r\x3d43\x26spec\x3dsvn70');
 
 
 changed_paths.push('/trunk/part3/time.jpg');
 changed_urls.push('/p/ourproject-007/source/browse/trunk/part3/time.jpg?r\x3d43\x26spec\x3dsvn70');
 ...
 <option value="/p/ourproject-007/source/browse/trunk/part3/genplots.m?r=43&amp;spec=svn70"
 selected="selected"
 >/trunk/part3/genplots.m</option>
 
 <option value="/p/ourproject-007/source/browse/trunk/part3/space.jpg?r=43&amp;spec=svn70"
 
 >/trunk/part3/space.jpg</option>
 
 <option value="/p/ourproject-007/source/browse/trunk/part3/time.jpg?r=43&amp;spec=svn70"
 ...
 <a class="ifOpened" href="/p/ourproject-007/source/detail?r=43&spec=svn70#publish">Publish your comments</a>
 ...
 by coolshenwen@gmail.com
 on Nov 23, 2011
 &nbsp; <a href="/p/ourproject-007/source/diff?spec=svn70&r=41&amp;format=side&amp;path=/trunk/part3/genplots.m&amp;old_path=/trunk/part3/genplots.m&amp;old=40">Diff</a>
 <br>
 ...
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/ourproject-007/source/detail?spec=svn70&r=40">r40</a>
 by coolshenwen@gmail.com
 on Nov 21, 2011
 &nbsp; <a href="/p/ourproject-007/source/diff?spec=svn70&r=40&amp;format=side&amp;path=/trunk/part3/genplots.m&amp;old_path=/trunk/part3/genplots.m&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/ourproject-007/source/list?path=/trunk/part3/genplots.m&start=43">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//ourproject-007.googlecode.com/svn/trunk/part3/genplots.m">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn70': '/trunk/part3/genplots.m'}
 codereviews = CR_controller.setup(
 {"token":"WJQQi95nalnzFUGrhj1V7j6d1fs:1375051343177","profileUrl":"/u/105550342260037177437/","projectName":"ourproject-007","projectHomeUrl":"/p/ourproject-007","assetHostPath":"https://ssl.gstatic.com/codesite/ph","loggedInUserEmail":"isakebedeachs@gmail.com","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/3783617020303179221","domainName":null,"relativeBaseUrl":""}, '', 'svn70', paths,
