...
<head>
 ...
 var codesite_token = "SN_czxp4ZtY2ijFZvnJc0l8TOL4:1375051354371";
 
 
 var CS_env = {"assetHostPath":"https://ssl.gstatic.com/codesite/ph","relativeBaseUrl":"","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/3783617020303179221","profileUrl":"/u/105550342260037177437/","domainName":null,"loggedInUserEmail":"isakebedeachs@gmail.com","token":"SN_czxp4ZtY2ijFZvnJc0l8TOL4:1375051354371","projectHomeUrl":"/p/ourproject-007","projectName":"ourproject-007"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fourproject-007%2Fsource%2Fbrowse%2Ftrunk%2Fpart3%2Fplotter.m" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/ourproject-007/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/ourproject-007/source/browse/trunk/part3/">part3</a><span class="sp">/&nbsp;</span>plotter.m</span>
 ...
 <a href="/p/ourproject-007/source/browse/trunk/part3/plotter.m?edit=1"
 ...
 <li><a href="/p/ourproject-007/source/browse/trunk/part3/plotter.m?r=39" title="Previous">&lsaquo;r39</a></li>
...
><td class="source">file_read = fopen(&#39;ASTAR_Statistics.txt&#39;,&#39;r&#39;);<br></td></tr
><tr
id=sl_svn70_2
...
><td class="source">file_line = fgetl(file_read);<br></td></tr
><tr
id=sl_svn70_10
...
><td class="source">if file_line != -1<br></td></tr
><tr
id=sl_svn70_13
...
><td class="source">if a &gt;=2<br></td></tr
><tr
id=sl_svn70_16
...
><td class="source">space = findstr(file_line,&quot;\t&quot;);<br></td></tr
><tr
id=sl_svn70_18

 onmouseover="gutterOver(18)"

><td class="source">city_time = [str2num(file_line(1:space(1))) str2num(file_line(space(1)+2:space(3)))];<br></td></tr
><tr
id=sl_svn70_19

 onmouseover="gutterOver(19)"

><td class="source">city_space = [str2num(file_line(1:space(1))) str2num(file_line(space(3)+2:length(file_line)))];<br></td></tr
><tr
id=sl_svn70_20
...
><td class="source">time(a-1,1) = city_time(1);<br></td></tr
><tr
id=sl_svn70_22

 onmouseover="gutterOver(22)"

><td class="source">time(a-1,2) =  city_time(2);<br></td></tr
><tr
id=sl_svn70_23

 onmouseover="gutterOver(23)"

><td class="source">mem(a-1,1)= city_space(1);<br></td></tr
><tr
id=sl_svn70_24

 onmouseover="gutterOver(24)"

><td class="source">mem(a-1,2)= city_space(2);<br></td></tr
><tr
id=sl_svn70_25
...
><td class="source">a = a +1;<br></td></tr
><tr
id=sl_svn70_28
...
><td class="source">plot(time)<br></td></tr
><tr
id=sl_svn70_36

 onmouseover="gutterOver(36)"

><td class="source">plot(mem)<br></td></tr
></table></pre>
<pre><table width="100%"><tr class="cursor_stop cursor_hidden"><td></td></tr></table></pre>
</td>
</tr></table>
...
<script type="text/javascript">
 ...
 <p>Change log</p>
 <div>
 <a href="/p/ourproject-007/source/detail?spec=svn70&amp;r=44">r44</a>
 by isakebedeachs@gmail.com
 on Nov 23, 2011
 &nbsp; <a href="/p/ourproject-007/source/diff?spec=svn70&r=44&amp;format=side&amp;path=/trunk/part3/plotter.m&amp;old_path=/trunk/part3/plotter.m&amp;old=39">Diff</a>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/ourproject-007/source/detail?r=44&spec=svn70';
 var publish_url = '/p/ourproject-007/source/detail?r=44&spec=svn70#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/trunk/part3/plotter.m');
 changed_urls.push('/p/ourproject-007/source/browse/trunk/part3/plotter.m?r\x3d44\x26spec\x3dsvn70');
 
 var selected_path = '/trunk/part3/plotter.m';
 ...
 <option value="/p/ourproject-007/source/browse/trunk/part3/plotter.m?r=44&amp;spec=svn70"
 selected="selected"
 >/trunk/part3/plotter.m</option>
 ...
 <a class="ifOpened" href="/p/ourproject-007/source/detail?r=44&spec=svn70#publish">Publish your comments</a>
 ...
 <a href="/p/ourproject-007/source/detail?spec=svn70&r=39">r39</a>
 by isakebedeachs@gmail.com
 on Nov 20, 2011
 &nbsp; <a href="/p/ourproject-007/source/diff?spec=svn70&r=39&amp;format=side&amp;path=/trunk/part3/plotter.m&amp;old_path=/trunk/part3/plotter.m&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">[No log message]</pre>
 </div>
 
 
 <a href="/p/ourproject-007/source/list?path=/trunk/part3/plotter.m&start=44">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//ourproject-007.googlecode.com/svn/trunk/part3/plotter.m">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn70': '/trunk/part3/plotter.m'}
 codereviews = CR_controller.setup(
 {"assetHostPath":"https://ssl.gstatic.com/codesite/ph","relativeBaseUrl":"","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/3783617020303179221","profileUrl":"/u/105550342260037177437/","domainName":null,"loggedInUserEmail":"isakebedeachs@gmail.com","token":"SN_czxp4ZtY2ijFZvnJc0l8TOL4:1375051354371","projectHomeUrl":"/p/ourproject-007","projectName":"ourproject-007"}, '', 'svn70', paths,
