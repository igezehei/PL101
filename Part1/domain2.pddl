...
<head>
 ...
 var codesite_token = "OeBdcUZdOl0KJqh94RGfRIDwo28:1375051138264";
 
 
 var CS_env = {"domainName":null,"relativeBaseUrl":"","profileUrl":"/u/105550342260037177437/","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/3783617020303179221","token":"OeBdcUZdOl0KJqh94RGfRIDwo28:1375051138264","projectHomeUrl":"/p/ourproject-007","assetHostPath":"https://ssl.gstatic.com/codesite/ph","projectName":"ourproject-007","loggedInUserEmail":"isakebedeachs@gmail.com"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fourproject-007%2Fsource%2Fbrowse%2Ftrunk%2Fpart1%2Fdomain2.pddl" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/ourproject-007/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/ourproject-007/source/browse/trunk/part1/">part1</a><span class="sp">/&nbsp;</span>domain2.pddl</span>
 ...
 <a href="/p/ourproject-007/source/browse/trunk/part1/domain2.pddl?edit=1"
...
><td class="source">(define (domain hanoi)<br></td></tr
><tr
id=sl_svn70_2
...
><td class="source">        (:typing no)<br></td></tr
><tr
id=sl_svn70_4
...
><td class="source">		(clear ?x)<br></td></tr
><tr
id=sl_svn70_6

 onmouseover="gutterOver(6)"

><td class="source">        (on ?x ?y)<br></td></tr
><tr
id=sl_svn70_7

 onmouseover="gutterOver(7)"

><td class="source">        (smaller ?x ?y)<br></td></tr
><tr
id=sl_svn70_8
...
><td class="source">	(:action move<br></td></tr
><tr
id=sl_svn70_11

 onmouseover="gutterOver(11)"

><td class="source">		:parameters (?disc ?from ?to)<br></td></tr
><tr
id=sl_svn70_12

 onmouseover="gutterOver(12)"

><td class="source">		:precondition (and (smaller ?to ?disc) <br></td></tr
><tr
id=sl_svn70_13

 onmouseover="gutterOver(13)"

><td class="source">                   			(on ?disc ?from) <br></td></tr
><tr
id=sl_svn70_14

 onmouseover="gutterOver(14)"

><td class="source">                   			(clear ?disc) <br></td></tr
><tr
id=sl_svn70_15

 onmouseover="gutterOver(15)"

><td class="source">                   			(clear ?to))<br></td></tr
><tr
id=sl_svn70_16

 onmouseover="gutterOver(16)"

><td class="source">		:effect  (and (clear ?from) <br></td></tr
><tr
id=sl_svn70_17

 onmouseover="gutterOver(17)"

><td class="source">              		(on ?disc ?to) <br></td></tr
><tr
id=sl_svn70_18

 onmouseover="gutterOver(18)"

><td class="source">              		(not (on ?disc ?from))  <br></td></tr
><tr
id=sl_svn70_19

 onmouseover="gutterOver(19)"

><td class="source">              		(not (clear ?to)))<br></td></tr
><tr
id=sl_svn70_20
...
<script type="text/javascript">
 ...
 on Nov 5, 2011
 &nbsp; <a href="/p/ourproject-007/source/diff?spec=svn70&r=4&amp;format=side&amp;path=/trunk/part1/domain2.pddl&amp;old_path=/trunk/part1/domain2.pddl&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/part1/domain2.pddl';
 ...
 <a href="/p/ourproject-007/source/list?path=/trunk/part1/domain2.pddl&start=4">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//ourproject-007.googlecode.com/svn/trunk/part1/domain2.pddl">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn70': '/trunk/part1/domain2.pddl'}
