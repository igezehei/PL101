...
<head>
 ...
 var codesite_token = "9TcmJbcFk5ufRjMB6oJBJDH2Msg:1375051113290";
 
 
 var CS_env = {"loggedInUserEmail":"isakebedeachs@gmail.com","assetHostPath":"https://ssl.gstatic.com/codesite/ph","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/3783617020303179221","domainName":null,"relativeBaseUrl":"","token":"9TcmJbcFk5ufRjMB6oJBJDH2Msg:1375051113290","profileUrl":"/u/105550342260037177437/","projectHomeUrl":"/p/ourproject-007","projectName":"ourproject-007"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fourproject-007%2Fsource%2Fbrowse%2Ftrunk%2Fpart1%2Fdomain1.pddl" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/ourproject-007/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/ourproject-007/source/browse/trunk/part1/">part1</a><span class="sp">/&nbsp;</span>domain1.pddl</span>
 ...
 <a href="/p/ourproject-007/source/browse/trunk/part1/domain1.pddl?edit=1"
...
><td class="source">(define (domain typed-blocksworld)<br></td></tr
><tr
id=sl_svn70_2
...
><td class="source">(:typing block hand)<br></td></tr
><tr
id=sl_svn70_4

 onmouseover="gutterOver(4)"

><td class="source">(:predicates (clear ?b - block)<br></td></tr
><tr
id=sl_svn70_5

 onmouseover="gutterOver(5)"

><td class="source">	     (on-table ?b - block)<br></td></tr
><tr
id=sl_svn70_6

 onmouseover="gutterOver(6)"

><td class="source">	     (empty ?h - hand)<br></td></tr
><tr
id=sl_svn70_7

 onmouseover="gutterOver(7)"

><td class="source">	     (holding ?h - hand ?b - block)<br></td></tr
><tr
id=sl_svn70_8

 onmouseover="gutterOver(8)"

><td class="source">	     (on ?b1 ?b2 - block))<br></td></tr
><tr
id=sl_svn70_9
...
><td class="source">(:action pickup<br></td></tr
><tr
id=sl_svn70_11

 onmouseover="gutterOver(11)"

><td class="source">  :parameters (?h - hand ?b - block)<br></td></tr
><tr
id=sl_svn70_12

 onmouseover="gutterOver(12)"

><td class="source">  :precondition (and (clear ?b) (on-table ?b) (empty ?h))<br></td></tr
><tr
id=sl_svn70_13

 onmouseover="gutterOver(13)"

><td class="source">  :effect (and (holding ?h ?b) (not (clear ?b)) (not (on-table ?b))<br></td></tr
><tr
id=sl_svn70_14

 onmouseover="gutterOver(14)"

><td class="source">               (not (empty ?h))))<br></td></tr
><tr
id=sl_svn70_15
...
><td class="source">(:action putdown<br></td></tr
><tr
id=sl_svn70_17
...
><td class="source">  :precondition (holding ?h ?b)<br></td></tr
><tr
id=sl_svn70_19

 onmouseover="gutterOver(19)"

><td class="source">  :effect (and (clear ?b) (empty ?h) (on-table ?b)<br></td></tr
><tr
id=sl_svn70_20

 onmouseover="gutterOver(20)"

><td class="source">               (not (holding ?h ?b))))<br></td></tr
><tr
id=sl_svn70_21
...
><td class="source">(:action stack<br></td></tr
><tr
id=sl_svn70_23

 onmouseover="gutterOver(23)"

><td class="source">  :parameters (?h - hand ?b ?underb - block)<br></td></tr
><tr
id=sl_svn70_24

 onmouseover="gutterOver(24)"

><td class="source">  :precondition (and (clear ?underb) (holding ?h ?b))<br></td></tr
><tr
id=sl_svn70_25

 onmouseover="gutterOver(25)"

><td class="source">  :effect (and (empty ?h) (clear ?b) (on ?b ?underb)<br></td></tr
><tr
id=sl_svn70_26

 onmouseover="gutterOver(26)"

><td class="source">               (not (clear ?underb)) (not (holding ?h ?b))))<br></td></tr
><tr
id=sl_svn70_27
...
><td class="source">(:action unstack<br></td></tr
><tr
id=sl_svn70_29
...
><td class="source">  :precondition (and (on ?b ?underb) (clear ?b) (empty ?h))<br></td></tr
><tr
id=sl_svn70_31

 onmouseover="gutterOver(31)"

><td class="source">  :effect (and (holding ?h ?b) (clear ?underb)<br></td></tr
><tr
id=sl_svn70_32

 onmouseover="gutterOver(32)"

><td class="source">               (not (on ?b ?underb)) (not (clear ?b)) (not (empty ?h)))))<br></td></tr
><tr
id=sl_svn70_33
...
<script type="text/javascript">
 ...
 on Nov 5, 2011
 &nbsp; <a href="/p/ourproject-007/source/diff?spec=svn70&r=4&amp;format=side&amp;path=/trunk/part1/domain1.pddl&amp;old_path=/trunk/part1/domain1.pddl&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/part1/domain1.pddl';
 ...
 <a href="/p/ourproject-007/source/list?path=/trunk/part1/domain1.pddl&start=4">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//ourproject-007.googlecode.com/svn/trunk/part1/domain1.pddl">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn70': '/trunk/part1/domain1.pddl'}
 codereviews = CR_controller.setup(
 {"loggedInUserEmail":"isakebedeachs@gmail.com","assetHostPath":"https://ssl.gstatic.com/codesite/ph","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/3783617020303179221","domainName":null,"relativeBaseUrl":"","token":"9TcmJbcFk5ufRjMB6oJBJDH2Msg:1375051113290","profileUrl":"/u/105550342260037177437/","projectHomeUrl":"/p/ourproject-007","projectName":"ourproject-007"}, '', 'svn70', paths,
