...
<head>
 ...
 var codesite_token = "cKfB_JJIMFVvPsMuMmdwQDWYCbU:1375051144630";
 
 
 var CS_env = {"assetHostPath":"https://ssl.gstatic.com/codesite/ph","token":"cKfB_JJIMFVvPsMuMmdwQDWYCbU:1375051144630","domainName":null,"assetVersionPath":"https://ssl.gstatic.com/codesite/ph/3783617020303179221","relativeBaseUrl":"","profileUrl":"/u/105550342260037177437/","projectHomeUrl":"/p/ourproject-007","loggedInUserEmail":"isakebedeachs@gmail.com","projectName":"ourproject-007"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fourproject-007%2Fsource%2Fbrowse%2Ftrunk%2Fpart1%2Fdomain3.pddl" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/ourproject-007/source/browse/trunk/">trunk</a><span class="sp">/&nbsp;</span><a href="/p/ourproject-007/source/browse/trunk/part1/">part1</a><span class="sp">/&nbsp;</span>domain3.pddl</span>
 ...
 <a href="/p/ourproject-007/source/browse/trunk/part1/domain3.pddl?edit=1"
...
><td class="source">(define (domain satellite)<br></td></tr
><tr
id=sl_svn70_2
...
><td class="source">(:typing instrument satellite)<br></td></tr
><tr
id=sl_svn70_4

 onmouseover="gutterOver(4)"

><td class="source">(:predicates<br></td></tr
><tr
id=sl_svn70_5

 onmouseover="gutterOver(5)"

><td class="source">	 (on_board ?i ?s) (supports ?i ?m) (pointing ?s ?d) (power_avail ?s) (power_on ?i) (calibrated ?i) (have_image ?d ?m) (calibration_target ?i ?d)(satellite ?x) (direction ?x) (instrument ?x) (mode ?x) )<br></td></tr
><tr
id=sl_svn70_6

 onmouseover="gutterOver(6)"

><td class="source">(:action turn_to<br></td></tr
><tr
id=sl_svn70_7

 onmouseover="gutterOver(7)"

><td class="source"> :parameters ( ?s ?d_new ?d_prev)<br></td></tr
><tr
id=sl_svn70_8
...
><td class="source">	(and (satellite ?s) (direction ?d_new) (direction ?d_prev)  (pointing ?s ?d_prev))<br></td></tr
><tr
id=sl_svn70_10

 onmouseover="gutterOver(10)"

><td class="source"> :effect<br></td></tr
><tr
id=sl_svn70_11

 onmouseover="gutterOver(11)"

><td class="source">	(and (pointing ?s ?d_new) (not (pointing ?s ?d_prev))))<br></td></tr
><tr
id=sl_svn70_12
...
><td class="source">(:action switch_on<br></td></tr
><tr
id=sl_svn70_14

 onmouseover="gutterOver(14)"

><td class="source"> :parameters ( ?i ?s)<br></td></tr
><tr
id=sl_svn70_15
...
><td class="source">	(and (instrument ?i) (satellite ?s)  (on_board ?i ?s) (power_avail ?s))<br></td></tr
><tr
id=sl_svn70_17
...
><td class="source">	(and (power_on ?i) (not (calibrated ?i)) (not (power_avail ?s))))<br></td></tr
><tr
id=sl_svn70_19
...
><td class="source">(:action switch_off<br></td></tr
><tr
id=sl_svn70_21
...
><td class="source">	(and (instrument ?i) (satellite ?s)  (on_board ?i ?s) (power_on ?i))<br></td></tr
><tr
id=sl_svn70_24
...
><td class="source">	(and (power_avail ?s) (not (power_on ?i))))<br></td></tr
><tr
id=sl_svn70_26
...
><td class="source">(:action calibrate<br></td></tr
><tr
id=sl_svn70_28

 onmouseover="gutterOver(28)"

><td class="source"> :parameters ( ?s ?i ?d)<br></td></tr
><tr
id=sl_svn70_29
...
><td class="source">	(and (satellite ?s) (instrument ?i) (direction ?d)  (on_board ?i ?s) (calibration_target ?i ?d) (pointing ?s ?d) (power_on ?i))<br></td></tr
><tr
id=sl_svn70_31
...
><td class="source">	 (calibrated ?i))<br></td></tr
><tr
id=sl_svn70_33
...
><td class="source">(:action take_image<br></td></tr
><tr
id=sl_svn70_35

 onmouseover="gutterOver(35)"

><td class="source"> :parameters ( ?s ?d ?i ?m)<br></td></tr
><tr
id=sl_svn70_36
...
><td class="source">	(and (satellite ?s) (direction ?d) (instrument ?i) (mode ?m)  (calibrated ?i) (on_board ?i ?s) (supports ?i ?m) (power_on ?i) (pointing ?s ?d) (power_on ?i))<br></td></tr
><tr
id=sl_svn70_38
...
><td class="source">	 (have_image ?d ?m))<br></td></tr
><tr
id=sl_svn70_40
...
<script type="text/javascript">
 ...
 on Nov 5, 2011
 &nbsp; <a href="/p/ourproject-007/source/diff?spec=svn70&r=4&amp;format=side&amp;path=/trunk/part1/domain3.pddl&amp;old_path=/trunk/part1/domain3.pddl&amp;old=">Diff</a>
 </div>
 ...
 var selected_path = '/trunk/part1/domain3.pddl';
 ...
 <a href="/p/ourproject-007/source/list?path=/trunk/part1/domain3.pddl&start=4">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//ourproject-007.googlecode.com/svn/trunk/part1/domain3.pddl">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn70': '/trunk/part1/domain3.pddl'}
 codereviews = CR_controller.setup(
 {"assetHostPath":"https://ssl.gstatic.com/codesite/ph","token":"cKfB_JJIMFVvPsMuMmdwQDWYCbU:1375051144630","domainName":null,"assetVersionPath":"https://ssl.gstatic.com/codesite/ph/3783617020303179221","relativeBaseUrl":"","profileUrl":"/u/105550342260037177437/","projectHomeUrl":"/p/ourproject-007","loggedInUserEmail":"isakebedeachs@gmail.com","projectName":"ourproject-007"}, '', 'svn70', paths,
